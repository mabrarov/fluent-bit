 ...
 *   5. Assert count == 2
 */
void flb_test_in_tail_ignore_active_older_files_reread_on_update(void)
{
    struct flb_lib_out_cb cb_data;
    struct test_tail_ctx *ctx;
...
void flb_test_in_tail_ignore_active_older_files_reread_on_update_default_read_from_head(void)
{
    struct flb_lib_out_cb cb_data;
    struct test_tail_ctx *ctx;
