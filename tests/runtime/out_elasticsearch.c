...
void flb_test_http_api_key(void)
{
    int ret;
    int size = sizeof(JSON_ES) - 1;
    flb_ctx_t *ctx;
...
void flb_test_response_success(void)
{
    int ret;
...
void flb_test_response_successes(void)
{
    int ret;
...
void flb_test_response_partially_success(void)
{
    int ret;
