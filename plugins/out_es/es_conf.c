                                      ...
                                      struct flb_config *config)
{
    ...
    flb_es_list_set_list(&ec->aws_unsigned_headers,
    ...
    if (tmp) {
        ...
        ret = config_set_es_action(ec->write_operation.value,
                                   ec->ra_id_key.value, ec->generate_id,
                                   ec, ctx);
...
static void elasticsearch_config_destroy(struct flb_elasticsearch_config *ec)
{
    ...
    flb_es_list_destroy(&ec->aws_unsigned_headers);
#endif
